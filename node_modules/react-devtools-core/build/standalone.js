module.exports = function(modules) {
    ...
    function startServer() {
        var port = arguments.length > 0 && void 0 !== arguments[0] ? arguments[0] : 8097, httpServer = __webpack_require__(260).createServer(), server = new ws.Server({
            server: httpServer
        }), connected = !1;
    ...
    var Panel = __webpack_require__(5), launchEditor = __webpack_require__(251), React = __webpack_require__(6), ReactDOM = __webpack_require__(35), node = null, onStatusChange = function() {}, wall = null, config = {
        reload: reload,
        alreadyFoundReact: !0,
	...
	*/
    ...
    }(), ContextMenu = __webpack_require__(34), PropState = __webpack_require__(180), React = __webpack_require__(6), SearchPane = __webpack_require__(212), SplitPane = __webpack_require__(223), TabbedPane = __webpack_require__(225), IS_VERTICAL_BREAKPOINT = 500, Container = function(_React$Component) {
	...
	*/
    ...
    var _createClass = function() {
        ...
        return _inherits(PropState, _React$Component), _createClass(PropState, [ {
            ...
            value: function() {
                ...
                var key = this.props.node.get("key"), ref = this.props.node.get("ref"), state = this.props.node.get("state"), context = this.props.node.get("context"), propsReadOnly = !this.props.node.get("canUpdate"), hasDollarR = "Composite" === nodeType || "Native" === nodeType;
    ...
    var _extends = Object.assign || function(target) {
        ...
        return _inherits(Node, _React$Component), _createClass(Node, [ {
            ...
            value: function() {
                ...
                var isCustom = "Composite" === nodeType, topTagStyle = inverted && !this.props.isBottomTagSelected ? styles.invertedTagName : isCustom ? styles.customTagName : styles.tagName, bottomTagStyle = inverted && this.props.isBottomTagSelected ? styles.invertedTagName : isCustom ? styles.customTagName : styles.tagName, topTagTextStyle = assign({}, styles.tagText, inverted && !this.props.isBottomTagSelected && styles.tagTextInverted);
                if (!children || "string" == typeof children || !children.length) {
                    var name = node.get("name"), content = children, isCollapsed = null === content || void 0 === content;
                    return React.createElement("div", {
                        style: styles.container
                    }, React.createElement("div", _extends({
                        style: headStyles,
                ...
                var tailStyles = assign({}, styles.tail, hovered && this.props.isBottomTagHovered && styles.headHover, selected && this.props.isBottomTagSelected && headSelectStyle, leftPad), guidelineStyle = assign({
                    ...
                    zIndex: selected ? 1 : 0
                }, styles.guideline, hovered && styles.guidelineHover, selected && styles.guidelineSelect);
                return React.createElement("div", {
                    style: styles.container
    ...
    }(), React = __webpack_require__(6), assign = __webpack_require__(178), PropVal = __webpack_require__(208), Props = function(_React$Component) {
        function Props() {
    ...
    var _createClass = function() {
        ...
        return _inherits(SplitPane, _React$Component), _createClass(SplitPane, [ {
            ...
            value: function() {
                var node = ReactDOM.findDOMNode(this);
                this.setState({
                    width: this.props.isVertical ? .3 * node.offsetWidth : .6 * node.offsetWidth,
                    height: .3 * node.offsetHeight
                });
            }
        }, {
            key: "onMove",
            value: function(x, y) {
                ...
                this.setState(function(prevState) {
                    return {
                        width: _this2.props.isVertical ? node.offsetLeft + node.offsetWidth - x : prevState.width,
                        height: _this2.props.isVertical ? prevState.height : node.offsetTop + node.offsetHeight - y
                    };
                });
            }
        }, {
            key: "render",
            value: function() {
                var _this3 = this, containerStyles = this.props.isVertical ? styles.container : styles.containerVertical, draggerStyles = this.props.isVertical ? styles.dragger : styles.draggerVertical, rightStyles = assign({}, containerStyles, {
    ...
    var _slicedToArray = function() {
        ...
        function Store(bridge) {
            ...
            _this.capabilities = {}, _this.bananaslugState = null, _this.colorizerState = null, 
            _this.regexState = null, _this.placeholderText = DEFAULT_PLACEHOLDER, _this.refreshSearch = !1, 
    ...
    }(), consts = __webpack_require__(186), hydrate = __webpack_require__(232), dehydrate = __webpack_require__(233), getIn = __webpack_require__(234), performanceNow = __webpack_require__(235), lastRunTimeMS = 5, cancelIdleCallback = window.cancelIdleCallback || clearTimeout, requestIdleCallback = window.requestIdleCallback || function(cb, options) {
    ...
    "use strict";
    var performanceNow, performance = __webpack_require__(236);
    ...
    "use strict";
    var performance, ExecutionEnvironment = __webpack_require__(237);
    ...
    }(), React = __webpack_require__(6), StyleEdit = __webpack_require__(239), BoxInspector = __webpack_require__(241), NativeStyler = function(_React$Component) {
    ...
    }(), React = __webpack_require__(6), BlurInput = __webpack_require__(240), StyleEdit = function(_React$Component) {
    ...
    var _extends = Object.assign || function(target) {
        ...
        return React.createElement("div", {
            ...
            style: styles.boxText
        }, left), children, React.createElement("span", {
            style: styles.boxText
        ...
        return _inherits(BoxInspector, _React$Component), _createClass(BoxInspector, [ {
            ...
            value: function() {
                ...
                }, "(", left, ", ", top, ")"), React.createElement("span", {
                    style: styles.innerText
                }, width, " × ", height))));
            }
        } ]), BoxInspector;
    ...
    }(), React = __webpack_require__(6), provideStore = __webpack_require__(243), RelayStore = __webpack_require__(244), QueriesTab = __webpack_require__(245), ElementPanel = __webpack_require__(250), StoreWrapper = provideStore("relayStore"), RelayPlugin = function() {
    ...
    }(), React = __webpack_require__(6), decorate = __webpack_require__(179), QueryList = __webpack_require__(246), QueryViewer = __webpack_require__(248), SplitPane = __webpack_require__(223), QueriesTab = function(_React$Component) {
        function QueriesTab() {
    ...
    }(), React = __webpack_require__(6), decorate = __webpack_require__(179), Query = __webpack_require__(247), QueryList = function(_React$Component) {
        function QueryList() {
    ...
    }(), _DataView = __webpack_require__(182), _DataView2 = _interopRequireDefault(_DataView), _DetailPane = __webpack_require__(206), _DetailPane2 = _interopRequireDefault(_DetailPane), _DetailPaneSection = __webpack_require__(207), _DetailPaneSection2 = _interopRequireDefault(_DetailPaneSection), _react = __webpack_require__(6), _react2 = _interopRequireDefault(_react), _decorate = __webpack_require__(179), _decorate2 = _interopRequireDefault(_decorate), _tidyGraphQL = __webpack_require__(249), _tidyGraphQL2 = _interopRequireDefault(_tidyGraphQL), QueryViewer = function(_React$Component) {
    ...
    var fs = __webpack_require__(2), path = __webpack_require__(3), child_process = __webpack_require__(252), shellQuote = __webpack_require__(253), COMMON_EDITORS = {
    ...
    var json = void 0 !== typeof JSON ? JSON : __webpack_require__(254), map = __webpack_require__(257), filter = __webpack_require__(258), reduce = __webpack_require__(259);
    ...
    exports.parse = __webpack_require__(255), exports.stringify = __webpack_require__(256);
}, function(module, exports) {
